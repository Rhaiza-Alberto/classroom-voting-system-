    ...
    <div class="container">
        ...
        <?php else:
            while ($position = $positions->fetch_assoc()): 
                ...
                $storedWinnerQuery = "SELECT w.user_id, w.vote_count, u.full_name, u.student_id
                                     FROM winners w
                ...
                $resultsQuery = "SELECT v.candidate_id, u.id as user_id, u.full_name, u.student_id, COUNT(v.id) as vote_count
                                FROM votes v
                                LEFT JOIN candidates c ON v.candidate_id = c.id
                                LEFT JOIN users u ON c.user_id = u.id
                                WHERE v.session_id = ? AND v.position_id = ?
                                GROUP BY v.candidate_id, u.id, u.full_name, u.student_id
                                ORDER BY vote_count DESC, u.full_name";
